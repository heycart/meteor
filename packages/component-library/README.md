...
```cli
npm i @heycart-ag/meteor-component-library
```
...
```js
import "@heycart-ag/meteor-component-library/styles.css";
...
```html
<script>
  import { MtButton } from "@heycart-ag/meteor-component-library";

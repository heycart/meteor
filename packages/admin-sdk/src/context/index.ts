...
export const getHeyCartVersion = createSender('contextHeyCartVersion', {});
export const compareIsHeyCartVersion = getCompareIsHeyCartVersion(getHeyCartVersion);
...
/**
 * Get the current HeyCart version
 */
export type contextHeyCartVersion = {
  responseType: string,
}

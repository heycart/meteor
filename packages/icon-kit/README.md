...
```sh
$ npm install @heycart-ag/meteor-icon-kit
```

Or if you prefer using Yarn:

```sh
$ yarn add @heycart-ag/meteor-icon-kit
```
...
```scss
@import "@heycart-ag/meteor-icon-kit/icons/meteor-icon-kit.scss";
```
...
```js
import wallet from "@heycart-ag/meteor-icon-kit/icons/regular/wallet.svg";
```
...
<script setup>
import ActivityIcon from "@heycart-ag/meteor-icon-kit/icons/regular/activity.svg";
</script>
```
